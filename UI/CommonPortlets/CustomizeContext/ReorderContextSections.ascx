<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReorderContextSections.ascx.cs" Inherits="Jenzabar.Portal.Web.UI.CommonPortlets.Controls.ReorderContextSections" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<div>
	<jenzabar:groupedgrid id="ItemsGrid" runat="server" HideTableHeadersWhenGridIsEmpty="True" CellPadding="0" DataKeyField="ID" GroupKeyField="ID" rendertableheaders="True" EnableAutoConfirmation="False" allowsorting="false">
		<COLUMNS>
			...
			<ASP:TEMPLATECOLUMN SortExpression="" HeaderText="SubSectionName">
				<ITEMTEMPLATE>
