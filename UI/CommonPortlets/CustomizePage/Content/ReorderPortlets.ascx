<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReorderPortlets.ascx.cs" Inherits="Jenzabar.Portal.Web.UI.CommonPortlets.CustomizePage.Content.ReorderPortlets" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
