...
function CheckBoxValidatorDisableCheckBox(chkId, mustBeChecked, ckbxId)
{
    var checkdisable = document.getElementById(ckbxId);
    var chkbox = document.getElementById(chkId);
    if (checkdisable && chkbox)
    {
        checkdisable.disabled = !chkbox.checked;
        if (checkdisable.disabled){checkdisable.checked == false;}
        //checkdisable.checked = (chkbox.checked == mustBeChecked);
    }
}
...
window.alert(control + '|' + mustBeChecked);
