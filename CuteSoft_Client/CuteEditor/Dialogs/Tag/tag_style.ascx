...
var OxOe827=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOe827[1],true)[OxOe827[0]]=function (){if(event[OxOe827[2]]){alert(element[OxOe827[3]].cssText);} ;} ;
</script>
