...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditUpdateView.ascx.cs" Inherits="Jenzabar.CRM.AdvancementOfficer.Web.Portlets.RelationshipManagementPortlet.EditUpdateView" %>
...
<table cellSpacing="0" cellPadding="2" width="100%">
	<tr>
		<td></td>
		<th>
			<asp:Label ID="lblCurrentInfo" Runat="server" /></th>
	</tr>
	<tr>
		...
		<td width="50%">
			<asp:DataGrid ID="dgCurrentValue" AutoGenerateColumns="False" ShowHeader="False" BorderWidth="0"
				Runat="server">
				<Columns>
					<asp:BoundColumn DataField="Label" />
	...
	<tr>
		<td><asp:button id="btnSave" Runat="server" />&nbsp;<asp:button id="btnCancel" CausesValidation="False" Runat="server" /></td>
	</tr>
</table>
