...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PaymentVerification.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.PaymentVerification" %>
...
<table width="100%" cellSpacing="3" cellPadding="3">
	...
	<tr>
		<td colspan="2" ><asp:button id="btnContinue" runat="server"></asp:button>&nbsp;&nbsp;&nbsp;
			<asp:Button id="btnCancel" runat="server"></asp:Button>&nbsp;&nbsp;&nbsp;
			<asp:button id="btnBack" runat="server"></asp:button></td>
	</tr>
</table>
