...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SelectPaymentMethod.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.SelectPaymentMethod" %>
...
<table height="40" cellSpacing="3" cellPadding="3">
	...
	<tr>
		<td><asp:button id="btnContinue" runat="server"></asp:button>&nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>
