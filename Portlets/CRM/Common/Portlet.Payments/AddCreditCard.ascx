<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AddCreditCard.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.AddCreditCard" %>
...
<table height="40" cellSpacing="3" cellPadding="3" width="704">
	...
	<tr>
		<td width="259">&nbsp;</td>
		<td><asp:button id="btnAdd" runat="server"></asp:button>&nbsp;&nbsp;&nbsp;
