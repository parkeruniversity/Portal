...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ModifyCreditCard.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.ModifyCreditCard" %>
...
<table height="40" cellSpacing="3" cellPadding="3" width="704">
	...
	<tr>
		<td width="172">&nbsp;</td>
		<td><asp:button id="btnOK" runat="server" onclick="btnOK_Click"></asp:button>&nbsp;&nbsp;&nbsp;
