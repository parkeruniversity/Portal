...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PortletSpecificConfig.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.PortletSpecificConfig" %>
	...
	<tr>
		...
		<td>
			<P><asp:dropdownlist id="ddlPaymentSelection" runat="server" OnSelectedIndexChanged="ddlPaymentSelection_SelectedIndexChanged"
				...
				<asp:ImageButton ID="imgPSNew" Runat="server" CausesValidation="False" onclick="imgPSNew_Click"></asp:ImageButton>&nbsp;
				<asp:ImageButton ID="imgPSModify" Runat="server" CausesValidation="False" onclick="imgPSModify_Click"></asp:ImageButton>&nbsp;
				<asp:ImageButton ID="imgPSDelete" Runat="server" CausesValidation="False" onclick="imgPSDelete_Click"></asp:ImageButton>
	...
	<tr>
		...
		<td>
			<P><asp:dropdownlist id="ddlMakeAPayment" runat="server" OnSelectedIndexChanged="ddlMakeAPayment_SelectedIndexChanged"
					AutoPostBack="True"></asp:dropdownlist>&nbsp;
				<asp:ImageButton ID="imgMPNew" Runat="server" CausesValidation="False" onclick="imgMPNew_Click"></asp:ImageButton>&nbsp;
				<asp:ImageButton ID="imgMPModify" Runat="server" CausesValidation="False" onclick="imgMPModify_Click"></asp:ImageButton>&nbsp;
				<asp:ImageButton ID="imgMPDelete" Runat="server" CausesValidation="False" onclick="imgMPDelete_Click"></asp:ImageButton>
