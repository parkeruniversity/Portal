...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PartialPayment.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.PartialPayment" %>
...
<table cellSpacing="3" cellPadding="3">
	...
	<tr>
		<td><asp:button id="btnContinue" runat="server" Text="Continue" onclick="btnContinue_Click"></asp:button>&nbsp;&nbsp;&nbsp;
