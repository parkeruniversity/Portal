<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SelectCreditCard.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.SelectCreditCard" %>
...
<table width="704" cellpadding="3" cellspacing="3" height="40">
	...
	<tr>
		<td width="123">&nbsp;</td>
		<td>
			<asp:Button id="btnOK" runat="server" onclick="btnOK_Click"></asp:Button>&nbsp;&nbsp;&nbsp;
