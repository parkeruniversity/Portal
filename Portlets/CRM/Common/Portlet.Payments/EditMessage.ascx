...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditMessage.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.EditMessage" %>
...
<table height="40" cellSpacing="3" cellPadding="3" width="704">
	...
	<tr>
		<td>&nbsp;</td>
		<td><asp:button id="btnSave" runat="server" tabIndex="30"></asp:button>&nbsp;&nbsp;&nbsp;
			<asp:button id="btnCancel" runat="server" tabIndex="40"></asp:button></td>
	</tr>
</table>
