<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MakeAPayment.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.Portlets.PaymentsPortlet.MakeAPaymentMethod" %>
...
<div class="pSection">
	<table height="40" cellSpacing="3" cellPadding="3">
		...
		<tr>
			<td colSpan="4"><asp:button id="btnContinue" runat="server"></asp:button>&nbsp;&nbsp;&nbsp;
