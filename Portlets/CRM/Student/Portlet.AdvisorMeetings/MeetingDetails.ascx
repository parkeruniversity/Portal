<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MeetingDetails.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.AdvisorMeetingsPortlet.MeetingDetails" %>
	...
	<TABLE id="tblAdvisorMeetMain" cellSpacing="1" cellPadding="1" width="99%">
		<TBODY>
			...
			<TR>
				...
				<TD align="left"><asp:dropdownlist id="ddlName" runat="server" AutoPostBack="True"></asp:dropdownlist><asp:label id="lblNameData" runat="server" Visible="False"></asp:label></TD>
			</TR>
			<TR>
			...
			<TR>
				<TD colSpan="3">
					<TABLE id="Table1" cellSpacing="2" cellPadding="1" width="300">
						<TR>
							<TD><asp:button id="btnSave" runat="server" Width="175px"></asp:button></TD>
							<TD><asp:button id="btnSaveAndSched" runat="server" Width="175px"></asp:button></TD>
							<TD><asp:button id="btnReset" runat="server" Width="175px"></asp:button></TD>
							<TD><asp:button id="btnCancel" runat="server" Width="175px"></asp:button></TD>
						</TR>
					</TABLE>
				</TD>
			</TR>
