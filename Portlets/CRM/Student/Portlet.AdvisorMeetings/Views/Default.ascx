...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Default.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.AdvisorMeetingsPortlet.Default"%>
...
<div class="psection" id="divMain" visible="true" runat="server" style="HEIGHT:auto">
	<TABLE id="tblAdvMeetDefMain" cellSpacing="2" cellPadding="2" width="99%">
			...
			<TD colSpan="2">
				<div id="divYesNo" style="BORDER-RIGHT: 2px; BORDER-TOP: 1px; DISPLAY: block; MARGIN: 1px; BORDER-LEFT: 0px; WIDTH: 95%; BORDER-BOTTOM: 0px; HEIGHT: 50px; align: left"
					...
					<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="50%" border="0">
						<TR>
							<TD><asp:button id="btnYes" runat="server" Width="110px" onclick="btnYes_Click"></asp:button></TD>
							<TD><asp:button id="btnNo" runat="server" Width="110px" onclick="btnNo_Click"></asp:button></TD>
						</TR>
					</TABLE>
				</div>
			</TD>
		...
		<TR>
			<TD colSpan="2"><asp:button id="btnDisplay" runat="server" Visible="False" onclick="btnDisplay_Click"></asp:button></TD>
		</TR>
		<TR>
			<TD></TD>
		</TR>
		...
		<TR>
			<TD colSpan="2">
				<TABLE id="tblAddDelete" cellSpacing="2" cellPadding="2" width="99%">
					...
					<tr>
						<td colSpan="2"><asp:LinkButton ID="LnkMeetDetails" runat="server" onclick="LnkMeetDetails_Click"></asp:LinkButton></td>
					</tr>
					<TR>
						<TD><asp:button id="btnAdd" runat="server" Width="110px" onclick="btnAdd_Click"></asp:button></TD>
						<TD><asp:button id="btnDelete" runat="server" onclick="btnDelete_Click"></asp:button></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
