...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Summary.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.DegreeAudit.Summary" %>
		...
		<TR>
			<TD align="left" colSpan="2">
				<table cellpadding="3">
					...
					<TR>
						<TD align="left" colSpan="2">
							<asp:HyperLink id="hlnkCXPdf" runat="server"></asp:HyperLink></TD>
					</TR>
					<tr>
					    <TD align=left colSpan=2><common:GlobalizedButton id="btnRecalculate" runat="server" textKey="TXT_RECALC_STUDENT_PROGRESS" /></TD>
				    </TR>
				</table>
			</TD>
		</TR>
