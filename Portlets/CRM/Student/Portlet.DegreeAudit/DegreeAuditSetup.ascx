...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DegreeAuditSetup.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.DegreeAudit.DegreeAuditSetup" %>
...
<div class="pSection">
	<table id="tblChangeSettings" cellpadding="0" cellspacing="0">
		...
		<TR>
			<TH align="left">
				<asp:Label id="lblCXWebReportsToView" runat="server" Width="274px" Font-Bold="True"></asp:Label></TH>
			<TD>
				<asp:CheckBox id="chkCXWebRpt" runat="server"></asp:CheckBox></TD>
		</TR>
		<tr>
			<td align="center"></td>
			<td><common:Hint id="hntCXWebReportToViewExplained" runat="server" TextKey="CX_WEB_DA_SETTINGS_DISPLAY_LINK" /></td>
			</TD>
		</tr>
		<TR>
			<TD></TD>
		...
		<TR>
			<TH align="left">
				<asp:Label id="lblCXWebCustomReportLink" runat="server" Width="256px"></asp:Label></TH>
			<TD height="3">
				<asp:TextBox id="txtCXWebCusomLink" Runat="server" MaxLength="50"></asp:TextBox></TD>
		</TR>
		<tr>
			<th height="19" align="left">
			</th>
			<td height="19">
				<common:Hint id="hntCXWebReportLinkExplained" runat="server" TextKey="SETTINGS_CX_WEB_REPORT_LINK_TEXT_DESC_DEG_AUD"></common:Hint></td>
		</tr>
		<TR>
			<TD height="3"></TD>
			<TD height="3"></TD>
