<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ViewTransactions.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.AccountInfoPortlet.ViewTransactions" %>
...
<table cellSpacing=3 cellPadding=3 width="100%">
	...
	<tr>
		<td>
				<jenzabar:groupedgrid id=dgTransactions runat="server" CellPadding="0" renderGroupHeaders="true">
					...
					<Columns>
						<jenzabar:GlobalizedBoundColumn HeaderTextKey="TXT_ACCOUNT_INFO_TRANSACTION_DESCRIPTION" DataField="TransactionDescription"></jenzabar:GlobalizedBoundColumn>
						<jenzabar:GlobalizedBoundColumn HeaderTextKey="TXT_ACCOUNT_INFO_TRANSACTION_DATE" DataField="TransactionDate"></jenzabar:GlobalizedBoundColumn>
						<jenzabar:GlobalizedTemplateColumn HeaderTextKey="TXT_ACCOUNT_INFO_TRANSACTION_AMOUNT">
							<ItemTemplate>
	...
	<tr>
		<td>
			<jenzabar:globalizedlinkbutton id="lnkMakeAPayment" runat="server" TextKey="TXT_ACCOUNT_INFO_MAKE_A_PAYMENT" />
		</td>
	</tr>
