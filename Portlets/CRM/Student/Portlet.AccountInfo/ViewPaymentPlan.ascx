<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ViewPaymentPlan.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.AccountInfoPortlet.ViewPaymentPlan" %>
