...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Detail.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.FinancialAidAdminPortlet.FinancialAidDetails" %>
