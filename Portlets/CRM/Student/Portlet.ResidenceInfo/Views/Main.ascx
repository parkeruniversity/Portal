<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Main.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.ResidenceInfoPortlet.Main" %>
...
<DIV class="psection">
	...
	<TABLE id="Table1" cellSpacing="3" cellPadding="3" width="100%" border="0">
		...
		<TR>
			...
			<TD><asp:dropdownlist id="ddlSession" runat="server" AutoPostBack="True" onselectedindexchanged="ddlSession_SelectedIndexChanged"></asp:dropdownlist><asp:label id="lblSessionDesc" runat="server" Visible="False"></asp:label></TD>
		</TR>
		<tr>
			<td>&nbsp;</td>
			<td></td>
	...
	<TABLE>
		...
		<TR>
			<TD>&nbsp;<asp:button id="btnBack" runat="server" Visible="False" onclick="btnBack_Click"></asp:button></TD>
		</TR>
	</TABLE>
</DIV>
