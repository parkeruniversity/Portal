...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SetOptions.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.RoomRoommatePreferencesPortlet.SetOptions" %>
