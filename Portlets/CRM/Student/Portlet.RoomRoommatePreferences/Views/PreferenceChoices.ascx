<%@ Control Language="c#" AutoEventWireup="True" Codebehind="PreferenceChoices.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.RoomRoommatePreferencesPortlet.PreferenceChoices" %>
