...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="RoomPreferences.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.RoomRoommatePreferencesPortlet.RoomPreferences" %>
...
<DIV class="pSection">
	<TABLE id="Table1" height="0" cellSpacing="3" cellPadding="3" width="100%" border="0">
						...
						<td width="60%">
							<TABLE id="Table2" height="0" cellSpacing="1" cellPadding="1" width="100%" border="0">
								<tr>
									...
									<td><asp:dropdownlist id="ddlSelectCampusBuilding" runat="server" Width="260px" AutoPostBack="True" onselectedindexchanged="ddlSelectCampusBuilding_SelectedIndexChanged"></asp:dropdownlist></td>
								</tr>
								<tr>
								...
								<tr>
									<td></td>
									<td><asp:button id="btnAddRoom" runat="server" onclick="btnAddRoom_Click"></asp:button></td>
								</tr>
							</TABLE>
						</td>
		...
		<TR>
			<TD><h6><asp:literal id="lblCurrentRoomPref" runat="server" Visible="True"></asp:literal></h6>
				<TABLE id="Table3" height="0" cellSpacing="5" cellPadding="5" width="100%" border="0">
					...
					<TR>
						<TD><asp:button id="btnSave" runat="server" Width="120px" onclick="btnSave_Click"></asp:button>&nbsp;&nbsp;&nbsp;<asp:button id="btnCancel" runat="server" Width="105px" CausesValidation="False" onclick="btnCancel_Click"></asp:button>
						</TD>
					</TR>
				</TABLE>
			</TD>
		...
		<TR>
			<TD><div id="divLnkPrefChoices" runat="server">&nbsp;&nbsp;&nbsp;<asp:linkbutton id="lnkPrefChoices" runat="server" onclick="lnkPrefChoices_Click"></asp:linkbutton></div>
			</TD>
		</TR>
		<TR>
			<TD>
				<div id="divLnkRoommatePref" runat="server">&nbsp;&nbsp;&nbsp;<asp:linkbutton id="lnkRoommatePref" runat="server" onclick="lnkRoommatePref_Click"></asp:linkbutton></div>
			</TD>
		</TR>
	</TABLE>
</DIV>
