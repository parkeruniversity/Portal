<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CourseNeedsProgramRequirements.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.CourseNeedsPortlet.ProgramRequirements" %>
