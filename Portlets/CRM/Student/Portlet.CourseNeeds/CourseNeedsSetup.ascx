<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CourseNeedsSetup.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.CourseNeedsPortlet.CourseNeedsSetup" %>
