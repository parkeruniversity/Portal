...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Main.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.GradeReportPortlet.Main" %>
<body onselectstart="return false;">
	...
	<Div class="pSection" id="divMain" runat="server" visible="true">
		<TABLE id="Table1" cellSpacing="3" cellPadding="3" width="100%" border="0">
				...
				<TD>
					<TABLE id="Table2" cellSpacing="0" cellPadding="3" width="100%" border="0">
						<TR>
							...
							<TD><asp:label id="lblTermSelected" runat="server" Visible="False"></asp:label><asp:dropdownlist id="ddlTerm" runat="server" AutoPostBack="True"></asp:dropdownlist>&nbsp;&nbsp;<asp:linkbutton id="lnkViewMidterm" runat="server"></asp:linkbutton></TD>
						</TR>
					</TABLE>
				</TD>
			</TR>
    		    	...
    		    	<TABLE id="Table3" cellSpacing="3" cellPadding="3" width="100%" border="0">
    					<asp:repeater id="rptCourseList" Runat="server">
	    			    	<ItemTemplate>
						    	<tr>
							    	<td class="header">
									    <asp:Label ID="lblDivision" Runat="server">&nbsp;<%#DataBinder.Eval(Container.DataItem, "DivisionDesc")%>
									    </asp:Label>
								    </td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										<asp:DataGrid ID="dgCourseList" Width="100%" Runat="server" BorderWidth="0" HeaderStyle-CssClass="header"
											...
											<Columns>
												<asp:BoundColumn DataField="DisplayedCourseCode" ItemStyle-Width="24%" ItemStyle-Wrap="False"></asp:BoundColumn>
												...
												<asp:BoundColumn DataField="FinalGrade" ItemStyle-Width="5%"></asp:BoundColumn>
												...
												<asp:BoundColumn DataField="QualityPoints" ItemStyle-Width="3%" ItemStyle-HorizontalAlign="Right"></asp:BoundColumn>
												<asp:TemplateColumn>
			...
			<TR>
				<TD><asp:imagebutton id="ibPrtFriendlyCustomRept" runat="server" Visible="False"></asp:imagebutton>&nbsp;<asp:linkbutton id="lnkPrtFriendlyCustomRept" runat="server" Visible="False"></asp:linkbutton></TD>
			</TR>
		</TABLE>
	</Div>
</body>
