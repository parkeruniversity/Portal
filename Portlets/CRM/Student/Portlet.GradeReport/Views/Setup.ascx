<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Setup.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.GradeReportPortlet.Setup" %>
		...
		<tr>
			<TD>
				<table cellspacing="3" cellpadding="3" border="0">
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<asp:dropdownlist id="ddlReportsToView" runat="server" Width="160px" AutoPostBack="True" onselectedindexchanged="ddlReportsToView_SelectedIndexChanged"></asp:dropdownlist></td>
