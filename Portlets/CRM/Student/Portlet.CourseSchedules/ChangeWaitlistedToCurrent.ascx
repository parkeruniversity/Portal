<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ChangeWaitlistedToCurrent.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.CourseSchedulesPortlet.ChangeWaitlistedToCurrent" %>
...
<div class="pSection" id="divMain" runat="server" visible="true">
	<table width="100%">
		...
		<tr>
			<td colSpan="5"><asp:button id="btnChangeWaitlistedToCurrent" Runat="server"></asp:button>&nbsp;&nbsp;
