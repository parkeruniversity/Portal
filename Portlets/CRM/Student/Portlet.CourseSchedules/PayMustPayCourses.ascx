<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PayMustPayCourses.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.CourseSchedulesPortlet.PayMustPayCourses" %>
