...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AddCourseRequisites.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.CourseSchedulesPortlet.AddCourseRequisites" %>
<div class="pSection">
