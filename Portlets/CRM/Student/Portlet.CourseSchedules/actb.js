function actb(obj,ca){
	...
	/* ---- Public Variables ---- */
	/* --- Styles --- */
	this.actb_bgColor = '#E8F8FE';
	this.actb_bgColorNav = '#002157';
	this.actb_textColor = '#000000';
	this.actb_textColorNav = '#FFFFFF';
...
function getElementWidth(Elem) {
	...
	function actb_generate(){
		...
		a.style.border='1px solid #002157'; 
		...
		for (i=0;i<actb_self.actb_keywords.length;i++){
			...
			if (j - 1 == actb_self.actb_lim && j < actb_total){
				r = a.insertRow(-1);
				r.style.backgroundColor = actb_self.actb_bgColorNav;
				c = r.insertCell(-1);
				c.style.color = actb_self.actb_textColorNav;
