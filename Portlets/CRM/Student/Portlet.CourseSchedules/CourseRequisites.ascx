...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CourseRequisites.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.CourseSchedulesPortlet.CourseRequisites" %>
