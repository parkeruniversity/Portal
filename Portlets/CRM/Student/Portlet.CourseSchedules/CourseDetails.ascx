<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CourseDetails.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.CourseSchedulesPortlet.CourseDetails" %>
...
<div class="pSection" id="divMain" runat="server" visible="true">
	<div id="divCourseDetails" visible="False" runat="server">
		...
		<table  cellpadding="2" border="0" width=100%>
			...
			<tr>
				<td nowrap colspan=6>
					...
					<asp:Repeater ID=rptInst Runat=server>
						...
						<ItemTemplate>
							<asp:label id="lblInstructorValue" Runat="server" NameFormat="LastNameFirst"></asp:label><framework:MyInfoPopup id="mipInstructorValue" Runat="server" NameFormat="LastNameFirst"></framework:MyInfoPopup >
							<asp:LinkButton id="LNK_email" runat="server" CommandName="email" Visible="False">
								<img id="IMG_email" src="" alt="" runat="server" />
							</asp:LinkButton>
							<asp:Label ID="lblSeperate1" Runat=server Visible=False></asp:Label>
						</ItemTemplate>
						<FooterTemplate>
						</FooterTemplate>
					</asp:Repeater>
			...
			<tr>
				<td colSpan="6"><asp:label ID="lblCoursePreamble" Runat=server Visible=False></asp:label> <asp:linkbutton id="lnkbCourseRequisites" Runat="server" Visible="False"></asp:linkbutton></td>
			</tr>
			<tr>
				<td colspan=6>
					<table  cellpadding="2" border="0" width=100%>
			...
			<tr>
				<td colSpan="6"><asp:linkbutton id="lnkbCourseTextBooks" Runat="server" Visible="False"></asp:linkbutton></td>
			</tr>
			<tr>
				<td colSpan="6"><asp:literal id="litCatalogLink" Runat="server" Visible="False"></asp:literal></td>
			</tr>
			<tr>
				<td colSpan="6"><asp:linkbutton id="lnkbAllCoursesInDept" Runat="server" Visible="False"></asp:linkbutton></td>
			</tr>
		</table>
	</div>
