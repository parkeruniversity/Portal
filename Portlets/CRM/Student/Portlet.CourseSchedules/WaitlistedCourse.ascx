...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="WaitlistedCourse.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.CourseSchedulesPortlet.WaitlistedCourse" %>
...
<div class="pSection" id="divMain" runat="server" visible="true">
	<table width="100%">
		...
		<tr>
			<td colSpan="5"><asp:button id="btnAddToWaitlisted" Runat="server"></asp:button>&nbsp;&nbsp;
