<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DefaultView.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.GPAProjectionPortlet.DefaultView" %>
...
<div class="pSection">
	...
	<jenzabar:GlobalizedLabel ID="lblMessage" TextKey="TXT_GPA_DEFAULT_NOT_A_STUDENT" Runat="server" Visible="False"></jenzabar:GlobalizedLabel>
</div>
