...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CalculateGPA.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.GPAProjectionPortlet.FindCandidate" %>
