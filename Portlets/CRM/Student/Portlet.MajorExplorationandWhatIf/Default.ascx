...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Default.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.MajorExplorationandWhatIfPortlet.Default" %>
<DIV class="psection" id="divControls" runat="server">
	<TABLE id="Table1" height="0" cellSpacing="3" cellPadding="3" width="100%" border="0">
		...
		<TR>
			<TD><asp:linkbutton id="lnkSetup" runat="server" Visible="False"></asp:linkbutton></TD>
		</TR>
		<TR>
			...
			<TD>
				<div id="divDDL" runat="server">
					<TABLE id="Table2" cellSpacing="5" cellPadding="5" width="100%" border="0">
						...
						<TR>
							<TD></TD>
							<TD><asp:button id="btnView" runat="server" Enabled="False"></asp:button></TD>
						</TR>
					</TABLE>
				</div>
			</TD>
