<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Reorder_Applications.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.StudentRequest.Reorder_Applications" %>
				...
				<asp:Repeater id="rptMainGrid" runat="server">
					<HeaderTemplate>
						<table width="100%" border="0" cellpadding="3" cellspacing="0">
							<tr>
								<td colspan="2" class="BorderTopLeftBottomRight"><b><asp:Literal ID="litObjectsIn" runat="server" /> <asp:Literal id="ltrCatName" runat="server" Text=<%# base._catname%> /></b></td>
							</tr>
							<tr>
								<td class="BorderLeftBottomSE">Order</td>
								<td class="BorderLeftRightBottomSE"><asp:Literal ID="litObjName" runat="server" /></td>
							</tr>
					</HeaderTemplate>
					<ItemTemplate>
						<tr valign="middle">
