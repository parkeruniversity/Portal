...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Default.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.VehicleInfoPortlet.Default" %>
<Div class="psection">
	<TABLE id="Table1" height="0" cellSpacing="3" cellPadding="3" width="100%" border="0">
		...
		<TR>
			<TD>
				<asp:LinkButton id="lnkViewYourVehicleInfo" runat="server" onclick="lnkViewYourVehicleInfo_Click"></asp:LinkButton>
			</TD>
		</TR>
	</TABLE>
</Div>
