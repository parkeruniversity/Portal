...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Main.ascx.cs" Inherits="Jenzabar.CRM.Student.Web.Portlets.UnofficialTranscriptPortlet.Main" %>
<%@ Import namespace="Jenzabar.CRM.Student.Web.Portlets.UnofficialTranscriptPortlet" %>
<body runat="server" onselectstart="return false;">
	...
	<div class="pSection" id="divHolds" runat="Server" visibile="true">
		...
		<cmn:groupedgrid id="dgHolds" runat="server" RenderTableHeaders="true" ShowHeader="true" CollapseSubItems="true">
			<TableHeaderTemplate>
				<font color="#ff0000">
		...
		<asp:table id="tblMain" style="BACKGROUND-POSITION: center center; BACKGROUND-REPEAT: repeat"
			...
			<asp:TableRow>
				<asp:TableCell>
					...
					<asp:DropDownList runat="server" Visible="False" AutoPostBack="True" ID="ddlDiv" onselectedindexchanged="ddlDiv_SelectedIndexChanged"></asp:DropDownList>
