...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CEM_ReorderQuestions_View.ascx.cs" Inherits="Jenzabar.CRM.Web.Portlets.CourseEvaluationPortlet.CEM_ReorderQuestions_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<div class="pSection">
