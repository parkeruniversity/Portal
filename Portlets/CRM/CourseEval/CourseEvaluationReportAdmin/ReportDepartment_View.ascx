<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportDepartment_View.ascx.cs" Inherits="Jenzabar.CRM.Web.Portlets.CourseEvaluationReportsPortlet.ReportDepartment_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
