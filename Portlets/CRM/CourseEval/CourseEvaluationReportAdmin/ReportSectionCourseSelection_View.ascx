<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportSectionCourseSelection_View.ascx.cs" Inherits="Jenzabar.CRM.Web.Portlets.CourseEvaluationReportsPortlet.ReportSectionCourseSelection_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
