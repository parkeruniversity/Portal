<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportSectionFacultySelection_View.ascx.cs" Inherits="Jenzabar.CRM.Web.Portlets.CourseEvaluationReportsPortlet.ReportSectionFacultySelection_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
