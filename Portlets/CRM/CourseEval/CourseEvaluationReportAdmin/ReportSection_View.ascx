<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportSection_View.ascx.cs" Inherits="Jenzabar.CRM.Web.Portlets.CourseEvaluationReportsPortlet.ReportSection_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
