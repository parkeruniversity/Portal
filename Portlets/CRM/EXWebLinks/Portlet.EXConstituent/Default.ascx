<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Default.ascx.cs" Inherits="Jenzabar.CRM.EXWebLinks.Web.Portlets.EXConstituentPortlet.Default" %>
...
<asp:Table ID="tblMain" Runat="server" Width="100%">
	<asp:TableRow>
		<asp:TableCell VerticalAlign="Top">
			<asp:PlaceHolder ID="plhConstituent" Runat="server" />
		</asp:TableCell>
	</asp:TableRow>
