<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Default.ascx.cs" Inherits="Jenzabar.CRM.EXWebLinks.Web.Portlets.EXStudentPortlet.Default" %>
...
<asp:Table ID="tblMain" Runat="server" Width="100%">
	<asp:TableRow>
		...
		<asp:TableCell VerticalAlign="Top">
			<asp:PlaceHolder ID="plhRegCont" Runat="server" />
		</asp:TableCell>
	</asp:TableRow>
	<asp:TableRow>
		<asp:TableCell VerticalAlign="Top">
		...
		<asp:TableCell VerticalAlign="Top">
			<asp:PlaceHolder ID="plhStuLife" Runat="server" />
		</asp:TableCell>
	</asp:TableRow>
</asp:Table>
