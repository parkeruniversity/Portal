<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Default.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.ContributionHistoryPortlet.Default" %>
<div class="pSection">
...
<P><asp:linkbutton id="LinkButton1" runat="server"></asp:linkbutton></P>
<P><asp:linkbutton id="LinkButton2" runat="server"></asp:linkbutton></P>
<P>
	<asp:LinkButton id="LinkButton3" runat="server"></asp:LinkButton></P>
<P>
	<asp:LinkButton id="LinkButton4" runat="server"></asp:LinkButton></P>
</div>