<%@ Control Language="c#" AutoEventWireup="false" Codebehind="OGConfirmAndSubmit.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.OnlineGivingPortlet.OGConfirmAndSubmit" %>
