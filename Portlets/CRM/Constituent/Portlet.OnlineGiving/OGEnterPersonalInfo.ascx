<%@ Control Language="c#" AutoEventWireup="false" Codebehind="OGEnterPersonalInfo.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.OnlineGivingPortlet.OGEnterPersonalInfo" %>
...
<asp:Table ID="Table1" Width="100%" BorderStyle="None" Runat="server">
	...
	<asp:TableRow ID="Tablerowc" Runat="server">
		<asp:TableCell ID="Tablecell16" Font-Bold="True" HorizontalAlign="Right" Width="30%" Runat="server">
	...
	<asp:TableRow ID="Tablerowx" Runat="server">
		...
		<asp:TableCell ID="Tablecell21" HorizontalAlign="Left" Width="30%" Runat="server">
			<asp:TextBox ID="txtZip" Runat="server"></asp:TextBox></asp:textbox>
	...
	<asp:TableRow ID="Tablerow9" Runat="server">
		...
		<asp:TableCell ID="Tablecell25" HorizontalAlign="Left" Width="30%" Runat="server">
			...
			<asp:regularexpressionvalidator id="valEmailFormat" runat="server" ControlToValidate="txtEmail" ValidationExpression="^.+@[^\.].*\.[a-z]{2,}$"></asp:regularexpressionvalidator>
		</asp:TableCell>
	</asp:TableRow>
...
<asp:Table ID="tblNavButtons" Width="100%" BorderStyle="None" Runat="server">
