<%@ Control Language="c#" AutoEventWireup="True" Codebehind="OGUpdatePersonalInfo.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.OnlineGivingPortlet.OGUpdatePersonalInfo" %>
