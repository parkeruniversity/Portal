<%@ Control Language="c#" AutoEventWireup="True" Codebehind="OGEnterPersonalInfo.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.OnlineGivingPortlet.OGEnterPersonalInfo" %>
