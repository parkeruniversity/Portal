<%@ Control Language="c#" AutoEventWireup="True" Codebehind="OGGiveGiftorPledgeDetail.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.OnlineGivingPortlet.OGGiveGiftorPledgeDetail" %>
