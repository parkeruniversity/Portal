<%@ Control Language="c#" AutoEventWireup="True" Codebehind="OGGiveGiftorPledge.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.OnlineGivingPortlet.OGGiveGiftorPledge" %>
