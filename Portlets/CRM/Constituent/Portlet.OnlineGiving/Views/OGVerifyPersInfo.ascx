<%@ Control Language="c#" AutoEventWireup="True" Codebehind="OGVerifyPersInfo.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.OnlineGivingPortlet.OGVerifyPersInfo" %>
