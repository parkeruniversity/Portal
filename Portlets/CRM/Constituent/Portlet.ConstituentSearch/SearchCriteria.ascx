<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchCriteria.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.ConstituentSearchPortlet.SearchCriteria" %>
