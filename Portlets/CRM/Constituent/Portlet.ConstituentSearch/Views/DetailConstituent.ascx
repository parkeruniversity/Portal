...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DetailConstituent.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.ConstituentSearchPortlet.DetailConstituent" %>
...
<table width="100%" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td nowrap height="40" align="left"><asp:Button ID="btnBack" Runat="server" onclick="btnBack_Click" /></td>
	</tr>
	<tr>
