...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DetailCompany.ascx.cs" Inherits="Jenzabar.CRM.Constituent.Web.Portlets.ConstituentSearchPortlet.DetailCompany" %>
