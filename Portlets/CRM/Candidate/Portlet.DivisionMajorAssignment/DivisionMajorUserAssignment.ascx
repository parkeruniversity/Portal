...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DivisionMajorUserAssignment.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.DivisionMajorAssignmentPortlet.DivisionMajorUserAssignment"%>
...
<TABLE id="Table1" cellSpacing="3" cellPadding="3" width="100%">
	...
	<TR>
		<TD><asp:button id="btnSave" Runat="server" Text="Save"></asp:button>&nbsp;
			<asp:button id="btnReset" runat="server" Text="Reset"></asp:button><FONT face="新細明體">&nbsp;</FONT><asp:button id="btnCancel" runat="server" Text="Cancel"></asp:button></TD>
	</TR>
</TABLE>
