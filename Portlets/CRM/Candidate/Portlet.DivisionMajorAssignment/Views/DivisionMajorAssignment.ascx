<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DivisionMajorAssignment.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.DivisionMajorAssignmentPortlet.DivisionMajorAssignment"%>
...
<TABLE id="Table1" cellSpacing="3" cellPadding="3" width="100%">
	...
	<TR>
		<TD width="25%">
			...
			<asp:dropdownlist id="ddlDivision" runat="server" AutoPostBack="True" DataTextField="DivDesc" DataValueField="DivUniqueIdentifier" onselectedindexchanged="ddlDivision_SelectedIndexChanged"></asp:dropdownlist></TD>
	</TR>
	<TR>
	...
	<TR>
		<TD><asp:button id="btnSave" Runat="server" Text="Save" onclick="btnSave_Click"></asp:button>&nbsp;
			<asp:button id="btnReset" runat="server" Text="Reset" onclick="btnReset_Click"></asp:button>&nbsp;<asp:button id="btnCancel" runat="server" Text="Cancel" onclick="btnCancel_Click"></asp:button></TD>
	</TR>
</TABLE>
