<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EditIntro.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.MakeInquiry.EditIntro" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
