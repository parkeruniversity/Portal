<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Default_View.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.MakeInquiry.Default_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
