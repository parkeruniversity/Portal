...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Main_View.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.ApplyOnline.Main_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<div class="pSection">
	<table cellSpacing="0" cellPadding="0" width="100%" border="0">
		...
		<asp:Repeater ID="rptMainGrid" Runat="server">
			...
			<ItemTemplate>
				<tr>
					<td colspan="3"><h5 style="padding:0px;margin:5px;"><b><%#DataBinder.Eval(Container.DataItem, "Name")%></b></h5></td>
				</tr>
