...
<%@ Control CodeBehind="Reorder_Categories.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.ApplyOnline.Reorder_Categories" %>
<jenzabar:errordisplay id="error" Runat="server" />
<h4><jenzabar:globalizedliteral id="litSetup" runat="server" textkey="TXT_AO_REORDER_CATEGORIES" /></h4>
