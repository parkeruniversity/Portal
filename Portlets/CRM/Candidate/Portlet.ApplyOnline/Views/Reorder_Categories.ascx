...
<%@ Control CodeBehind="Reorder_Categories.ascx.cs" Language="c#" AutoEventWireup="True" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.ApplyOnline.Reorder_Categories" %>
