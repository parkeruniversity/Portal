...
<%@ Control CodeBehind="Reorder_Applications.ascx.cs" Language="c#" AutoEventWireup="True" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.ApplyOnline.Reorder_Applications" %>
