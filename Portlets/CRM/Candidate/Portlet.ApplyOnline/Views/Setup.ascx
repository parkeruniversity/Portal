...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Setup.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.ApplyOnline.Setup" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
