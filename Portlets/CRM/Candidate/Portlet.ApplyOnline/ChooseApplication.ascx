<%@ Control CodeBehind="ChooseApplication.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.ApplyOnline.ChooseApplication" %>
