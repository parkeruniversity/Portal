<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ConfigureInitiateContactText.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.InitiateContactPortlet.ConfigureInitiateContactText" %>
...
<table align="center">
	<tr>
		<td noWrap height="40"><asp:button id="btnSave" Runat="server" Width="88px"></asp:button></td>
		<td noWrap height="40"><asp:button id="btnCancel" Runat="server" Width="88px"></asp:button></td>
	</tr>
</table>
