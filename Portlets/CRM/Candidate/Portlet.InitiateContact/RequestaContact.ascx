...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="RequestaContact.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.InitiateContactPortlet.RequestaContact" %>
