...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ScheduleaVisit.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.InitiateContactPortlet.ScheduleaVisit" %>
...
<table align="center">
	<tr>
		<td noWrap height="40"><asp:button id="btnSubmit" Runat="server" onclick="btnSubmit_Click"></asp:button></td>
		<td noWrap height="40"><asp:button id="btnCancel" Runat="server" CausesValidation="False" onclick="btnCancel_Click"></asp:button></td>
	</tr>
</table>
