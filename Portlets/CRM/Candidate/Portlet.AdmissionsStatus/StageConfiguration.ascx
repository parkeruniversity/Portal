<%@ Control Language="c#" AutoEventWireup="false" Codebehind="StageConfiguration.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.AdmissionsStatusPortlet.StageConfiguration" %>
...
<table width="100%">
	<tr>
		<td align="center">
			<asp:Button ID="btnSaveStages" Runat="server" Visible="False"></asp:Button>&nbsp;
