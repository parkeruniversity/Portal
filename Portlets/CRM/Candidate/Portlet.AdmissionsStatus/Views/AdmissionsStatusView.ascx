<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AdmissionsStatusView.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.AdmissionsStatusPortlet.AdmissionsStatusView" %>
...
<div id="divContent" class="pSection" runat="server" visible="false">
	...
	&nbsp;&nbsp;<asp:dropdownlist id="ddlProgram" Runat="server" AutoPostBack="True" onselectedindexchanged="ddlProgram_SelectedIndexChanged"></asp:dropdownlist>&nbsp;<asp:Label ID="lblProgram" Runat="server"></asp:Label>
	...
	<asp:Table ID="tblNextStep" Visible="True" Width="100%" BorderStyle="None" Runat="server">
		<asp:TableRow ID="trApplyForAdmissions" Visible="False" Runat="server">
			<asp:TableCell>
				&nbsp;&nbsp;<asp:LinkButton ID="lnkbApplyForAdmissions" Runat="server" Visible="false" /><asp:LinkButton ID="lnkbApplyForAdmissionsFB2" Runat="server" Visible="false" />
			</asp:TableCell>
		</asp:TableRow>
