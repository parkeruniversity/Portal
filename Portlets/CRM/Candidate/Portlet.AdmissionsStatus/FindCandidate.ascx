<%@ Control Language="c#" AutoEventWireup="false" Codebehind="FindCandidate.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.AdmissionsStatusPortlet.FindCandidate" %>
