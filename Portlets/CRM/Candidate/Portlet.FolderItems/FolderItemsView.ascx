<%@ Control Language="c#" AutoEventWireup="false" Codebehind="FolderItemsView.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.FolderItemsPortlet.FolderItemsView" %>
