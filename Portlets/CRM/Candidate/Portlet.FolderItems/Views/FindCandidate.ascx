<%@ Control Language="c#" AutoEventWireup="True" Codebehind="FindCandidate.ascx.cs" Inherits="Jenzabar.CRM.Candidate.Web.Portlets.FolderItemsPortlet.FindCandidate" %>
