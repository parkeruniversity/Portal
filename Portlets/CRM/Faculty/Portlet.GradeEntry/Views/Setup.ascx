...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Setup.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.GradeEntryPortlet.Setup" %>
		...
		<TR>
			<td>
				<table cellSpacing="3" cellPadding="3" border="0">
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<asp:checkbox id="cbxAllowLDoAEntry" AutoPostback="true" runat="server" oncheckedchanged="cbxAllowLDoAEntry_CheckedChanged" /></td>
					...
					<tr>
					    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					        <asp:RadioButton ID="rbLDoAGrades" runat="server"  GroupName="LDoAOption"/></td>
					    <td><asp:Label ID="lblLDoAGradesDesc" runat="server" /></td>
					</tr>
				</table>
					<tr>
					  <td>
    					<table width="75%" cellSpacing="3" cellPadding="3" border="0">
                			<asp:PlaceHolder ID="phGrades" Runat="server">
	    		            	<ul id="ulGrades" runat="server"></ul>
				            </asp:PlaceHolder>
                            <tr><td></td><td></td><td></td><td>	
                            <asp:Button id="btnMoreGrade" runat="server" text="More .." onclick="btnMoreGrade_Click" /> 
                            </td></tr>
				        </table>
				      </td>
	                </tr>
