...
<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="GradingCourseList.ascx.cs"
    Inherits="Jenzabar.CRM.Faculty.Web.Portlets.GradeEntryPortlet.GradingCourseList" %>
			...
			<td>
				<table cellSpacing="3" cellPadding="3" width="100%">
					<tr>
						...
						<td align="left" width="25%"><asp:dropdownlist id="ddlbDivision" runat="server" Visible="True" Width="200px" AutoPostBack="false" /></td>
						<td	width="7%"><cmn:globalizedliteral id="lblTerm" runat="server" Visible="True" TextKey="TXT_FACT_GE_TERM"></cmn:globalizedliteral></td>
						<td align="left" width="10%"><asp:dropdownlist id="ddlbTerm" runat="server" Visible="True" Width="240px" AutoPostBack="false" /></td>
						<td vAlign="middle" align="right"><cmn:globalizedbutton id="btnSearch" runat="server" Visible="True" TextKey="TXT_FACT_GE_SEARCH" onclick="btnSearch_Click"></cmn:globalizedbutton></td>
					</tr>
				</table>
			</td>
		</tr>
...
<div class="pSection" id="divCourses" runat="server">
	<cmn:groupedgrid id="dgCourses" Runat="server"  
		DataKeyField="ERPCourseKey" RenderTableHeaders="true" onprerender="dgCourses_PreRender">
		<COLUMNS>
