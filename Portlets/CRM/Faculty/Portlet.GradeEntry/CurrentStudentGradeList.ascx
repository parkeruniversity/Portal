...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CurrentStudentGradeList.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.GradeEntryPortlet.CurrentStudentGradeList" %>
