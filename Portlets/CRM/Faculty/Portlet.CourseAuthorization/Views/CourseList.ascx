<%@ Control Language="c#" AutoEventWireup="True" Codebehind="CourseList.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.CourseAuthorizationPortlet.CourseList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
		...
		<div class="pSection">
			<common:GroupedGrid ID="CourseGrid" RenderGroupHeaders="True" runat="server">
				...
				<Columns>
					...
					<crm:XmlBoundColumn HeaderText="All Requirements" DataXmlField="AllRequirementsAuthorizedCount" />
