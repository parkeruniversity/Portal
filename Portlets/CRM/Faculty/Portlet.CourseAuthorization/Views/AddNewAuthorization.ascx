...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AddNewAuthorization.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.CourseAuthorizationPortlet.AddNewAuthorization" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
