...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ClassList.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.FacultyCourseControlPortlet.ClassList" %>
...
<div class="pSection" id="divHeader" runat="server">
		...
		<table style="MARGIN-BOTTOM: 3px" cellSpacing="0" cellPadding="0" width="100%" border="0" id="tblExportLinks" runat="server">
			<tr>
				<td>
					...
					<a href="mailto:<%= base._emailAllStudents%>" >
						<%=Globalizer.GetGlobalizedString("TXT_EMAIL_ALL_STUDENTS")%>
					</a>
				</td>
			</tr>
		</table>
 ...
 ItemStyle-Wrap="False" />
				<cmn:GlobalizedTemplateColumn HeaderTextKey="TXT_EMAIL" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
					<ItemTemplate>
						<a href="mailto:<%# DataBinder.Eval( Container.DataItem, "StudentEmail" )%>">
