...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="FacultySchedule.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.FacultyCourseControlPortlet.FacultySchedule" %>
