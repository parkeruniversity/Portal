...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="FCCDefault.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.FacultyCourseControlPortlet.FCCDefault" %>
...
<div class="pSection" id="divMain" runat="server" visible="False">
	<table cellSpacing="3" cellPadding="0" width="100%" border="0">
		<tr>
			<td><cmn:globalizedlinkbutton id="lnkViewDetails" runat="server" TextKey="TXT_VIEW_DETAILS" onclick="lnkViewDetails_Click"></cmn:globalizedlinkbutton></td>
			<td align="right"><cmn:globalizedlinkbutton id="lnkFacultySchedule" runat="server" TextKey="TXT_FAC_VIEW_MY_FACULTY_SCHEDULE" onclick="lnkFacultySchedule_Click"></cmn:globalizedlinkbutton></td>
		</tr>
	</table>
