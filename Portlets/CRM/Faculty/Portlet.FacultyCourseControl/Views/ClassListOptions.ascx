<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ClassListOptions.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.FacultyCourseControlPortlet.ClassListOptions" %>
...
<div class="pSection">
	...
	<table>
		...
		<tr>
			<td>&nbsp;</td>
			<td nowrap>
			    <cmn:GlobalizedCheckBox id="gcbShowHours" Runat="server" TextKey="FCC_SETTINGS_SHOW_CREDIT_HOURS" />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			<td>&nbsp;</td>
			<td nowrap>
				<cmn:GlobalizedCheckBox id="gcbShowPhoto" Runat="server" TextKey="FCC_SETTINGS_SHOW_PHOTO" />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
