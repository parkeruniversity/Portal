<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SearchResults.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.FacilitiesSchedulePortlet.SearchResults" %>
