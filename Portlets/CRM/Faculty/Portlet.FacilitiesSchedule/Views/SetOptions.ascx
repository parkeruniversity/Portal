...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SetOptions.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.FacilitiesSchedulePortlet.SetOptions" %>
...
<table cellSpacing="1" cellPadding="3" width="100%">
	...
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td colSpan="2"><jenzabar:GlobalizedButton TextKey="TXT_SAVE" id="btnSave" Runat="server" onclick="btnSave_Click"></jenzabar:GlobalizedButton>
			<jenzabar:GlobalizedButton ID="btnCancel" TextKey="TXT_CANCEL" Runat="server" onclick="btnCancel_Click"></jenzabar:GlobalizedButton></td>
	</tr>
</table>
</div>
