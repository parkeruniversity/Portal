<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AdvancedSearch.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.AdviseeRosterPortlet.AdvancedSearch" %>
...
<div class="pSection">
	...
	<table cellSpacing="2" cellPadding="2" width="100%" border="0">
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<jenzabar:GlobalizedButton id="btnSave" runat="server" TextKey="TXT_SAVE"></jenzabar:GlobalizedButton>&nbsp;
				<jenzabar:globalizedbutton id="btnReset" runat="server" TextKey="TXT_RESET"></jenzabar:globalizedbutton>&nbsp;
