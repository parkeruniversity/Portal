<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AdviseeDetails.ascx.cs" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.AdviseeRosterPortlet.AdviseeDetails" %>
...
<div class="pSection">
	...
	<table id='tblTools' cellSpacing="3" cellPadding="0" border="0" width="100%" runat=server>
		<tr>
			<td width="50%" valign="top">
				<table id='tblLinks' cellSpacing="0" class="groupedGrid" cellPadding="0" border="0" width="100%" runat=server>
					<tr>
			...
			<td width="50%" valign="top">
				<table id='tblFinAid' cellSpacing="0" class="groupedGrid" cellPadding="0" border="0" width="100%" runat=server>
