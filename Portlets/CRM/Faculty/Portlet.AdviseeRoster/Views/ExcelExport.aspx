...
<%@ Page language="c#" Codebehind="ExcelExport.aspx.cs" AutoEventWireup="True" Inherits="Jenzabar.CRM.Faculty.Web.Portlets.AdviseeRosterPortlet.ExcelExport" %>
<HTML>
	<HEAD>
		...
		<%#base._name%>&nbsp;<%#base._studentcount%>
					...
					<Columns>
						...
						<jenzabar:GlobalizedBoundColumn DataField="AdviseeID" HeaderTextKey="TXT_STUDENT_ID" ItemStyle-HorizontalAlign="Left"
							ItemStyle-VerticalAlign="Top" Visible="true" />
						<jenzabar:GlobalizedBoundColumn DataField="AdviseeLastName" HeaderTextKey="TXT_LAST_NAME" ItemStyle-HorizontalAlign="Left"
							ItemStyle-VerticalAlign="Top" Visible="true" />
						<jenzabar:GlobalizedBoundColumn DataField="AdviseeFirstName" HeaderTextKey="TXT_FIRST_NAME" ItemStyle-HorizontalAlign="Left"
							ItemStyle-VerticalAlign="Top" Visible="true" />
						<jenzabar:GlobalizedBoundColumn DataField="Email" HeaderTextKey="TXT_EMAIL" ItemStyle-HorizontalAlign="Left"
							ItemStyle-VerticalAlign="Top" Visible="true" />
					    <jenzabar:GlobalizedBoundColumn DataField="Classification" HeaderTextKey="TXT_CLASSIFICATION" ItemStyle-HorizontalAlign="Left"
							ItemStyle-VerticalAlign="Top" Visible="true" />
						...
						<jenzabar:GlobalizedBoundColumn DataField="RegistrationClearance" HeaderTextKey="TXT_AR_REGISTRATION_CLEARANCE"
							ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" visible="false" ></jenzabar:GlobalizedBoundColumn>
						<jenzabar:GlobalizedBoundColumn DataField="Advisor" HeaderTextKey="TXT_ADVISORS" ItemStyle-HorizontalAlign="Left"
							ItemStyle-VerticalAlign="Top" Visible="true" />
					</Columns>
