...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ImportSettings_Payment.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.Importing.ImportSettings_Payment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
