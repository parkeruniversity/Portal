...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ImportSections_ViewSection.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.Importing.ImportSections_ViewSection" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
