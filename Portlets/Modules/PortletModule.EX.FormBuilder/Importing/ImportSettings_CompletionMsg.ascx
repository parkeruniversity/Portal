...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ImportSettings_CompletionMsg.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.Importing.ImportSettings_CompletionMsg" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
