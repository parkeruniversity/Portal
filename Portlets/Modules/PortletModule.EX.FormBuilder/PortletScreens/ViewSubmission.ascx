<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewSubmission.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.PortletScreens.ViewSubmission" %>
