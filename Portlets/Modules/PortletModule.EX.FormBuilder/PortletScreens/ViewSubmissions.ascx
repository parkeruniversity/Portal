<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ViewSubmissions.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.PortletScreens.ViewSubmissions" %>
