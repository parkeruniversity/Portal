<%@ Control CodeBehind="DisplayIntro.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.PortletScreens.DisplayIntro" %>
