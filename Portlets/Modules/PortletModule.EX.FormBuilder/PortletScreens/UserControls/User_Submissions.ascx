<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="User_Submissions.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.PortletScreens.UserControls.User_Submissions" %>
