...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MoveReorderQuestions_View.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.Sections.MoveReorderQuestions_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
