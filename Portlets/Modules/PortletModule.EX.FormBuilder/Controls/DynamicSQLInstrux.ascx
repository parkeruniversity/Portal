<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DynamicSQLInstrux.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.Controls.DynamicSQLInstrux" %>
