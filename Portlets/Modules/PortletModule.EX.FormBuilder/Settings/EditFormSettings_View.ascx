...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditFormSettings_View.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.Settings.EditFormSettings_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
		...
		<fieldset>
			<table cellSpacing="3" cellPadding="3" class="SmallText">
                <tr id="trDupeFormName" runat="server">
                    <td colspan="2" class="alt NameCell">
                        <div class="FormBuilder"><span class="ErrorMsg">
                            <asp:Literal ID="litDupeFormName" runat="server" /></span></div>
                    </td>
                </tr>
				<tr>
