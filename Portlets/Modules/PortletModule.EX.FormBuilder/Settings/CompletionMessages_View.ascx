...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CompletionMessages_View.ascx.cs" Inherits="Jenzabar.CRM.Common.Web.PortletModule.EX.FormBuilder.Settings.CompletionMessages_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
function openWinInstrux(){
	openWindow('<%= this.ResolveUrl("~/Portlets/Modules/PortletModule.EX.FormBuilder/Settings/keywords.htm") %>','instrux',450,450,1,0);
}
			...
			<table cellSpacing="3" cellPadding="3" class="SmallText" border="0">
				...
				<tr>
					...
					<td>
						...
						<jics:TextEditor id="tbeScrMsgSucc" MaxLength="6000" Runat="server" />
					</td>
				</tr>
				<tr>
						...
						<table cellSpacing="3" cellPadding="3" class="FBQuestionList" width="75%" border="0">
							...
							<tr>
								...
								<td colspan="2" >
									...
									<div id="divSuccFormatMsgTBE" runat="server" > <!--  class="EmMsg" -->
										<jics:TextEditor id="tbeEmMsgSucc" runat="server" MaxLength="6000" />
									</div>
								</td>
							</tr>
						</table>
				...
				<tr>
					...
					<td>
						...
						<jics:TextEditor id="tbeScrMsgUnSucc" MaxLength="6000" Runat="server" />
					</td>
				</tr>
				<tr>
						...
						<table cellSpacing="3" cellPadding="3" class="FBQuestionList" width="75%" border="0">
							...
							<tr>
								...
								<td colspan="2" >
									...
									<div id="divUnSuccFormatMsgTBE" runat="server"><!--  class="EmMsg" -->
										<jics:TextEditor id="tbeEmMsgUnSucc" runat="server" MaxLength="6000" />
									</div>
								</td>
							</tr>
						</table>
