...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AddEditQuestion_View.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.Questions.AddEditQuestion_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<script language="javascript">
	...
	function openWin(){
		openWindow('<%= this.ResolveUrl("~/Portlets/Modules/PortletModule.FormBuilder/Questions/Instructions.htm") %>','instrux',450,450,1,0);
	}
