...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ImportSettings_View.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.Importing.ImportSettings_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<div class="FormBuilder">
	...
	<div class="pSection">
		...
		<h5><strong>
			<cmn:GlobalizedLiteral Runat="server" TextKey="FB_IMPORT_SETTINGS_TXT" id="glBodyTitle" />
		</strong></h5>
		<p class="hint">
			<%=Globalizer.Format("FB_IMPORT_Settings_HINT_TXT",settingType)%>
		</p>
		...
		<table class="groupedGrid " cellspacing="1" cellpadding="0" border="0" style="margin-bottom:-2px;">
			<thead>
				<tr>
					<td>
						<%= Globalizer.GetGlobalizedString("FB_IMPORT_Settings_GRIDTITLE_TXT") %> &nbsp; 
