...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ImportIntroductions_View.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.Importing.ImportIntroductions_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<div class="FormBuilder">
	...
	<div class="pSection">
		...
		<h5>
			<strong>
				<cmn:GlobalizedLiteral Runat="server" TextKey="FB_IMPORT_INTRODUCTIONS" id="glBodyTitle" />
			</strong>
		</h5>
		<p class="hint" id="pHint" runat="server">
			<cmn:GlobalizedLiteral Runat="server" TextKey="FB_IMPORT_INTRO_MAIN_HINT_TXT" id="glHint" />
		</p>
