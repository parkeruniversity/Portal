...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AddEditInstructions_View.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.Sections.AddEditInstructions_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<fieldset>
			<table cellSpacing="3" cellPadding="3" class="SmallText">
				<TBODY>
					<tr>
						<td colspan="3">
							<FWK:ImagePlacementandText ID="_iptInstructions" runat="server"/>
						</td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>
