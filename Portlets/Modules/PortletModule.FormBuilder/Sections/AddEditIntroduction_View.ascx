...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AddEditIntroduction_View.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.Sections.AddEditIntroduction_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
