...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AddEditSection_View.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.Sections.AddEditSection_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<fieldset>
			<table cellSpacing="3" cellPadding="3" class="SmallText">
				<TBODY>
					...
					<tr>
						<FWK:ImagePlacementandText ID="_iptSection" runat="server"/>
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>
						<td>
