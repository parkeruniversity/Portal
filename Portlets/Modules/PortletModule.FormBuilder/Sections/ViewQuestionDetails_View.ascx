...
<%@ Register TagPrefix="formbuilder" namespace="Jenzabar.FRM" assembly="FRM" %>
<%@ Register TagPrefix="common" namespace="Jenzabar.Common.Web.UI.Controls" assembly="Jenzabar.Common" %>
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ViewQuestionDetails_View.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.Sections.ViewQuestionDetails_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
