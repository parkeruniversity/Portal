<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewSubmission_All.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.PortletScreens.ViewSubmission_All" %>
