<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SaveForm.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.PortletScreens.SaveForm" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<div id="divGuest" runat="server" visible="false">
		<table cellSpacing="0" cellPadding="0" width="100%">
			...
			<tr>
				...
				<td width="40">&nbsp;</td>
				<td>
				     <asp:Label runat="server" style="display: none;" Text="Rename Page Button"  ID="accesibilitynewName" AssociatedControlID="tbEmail"></asp:Label>
