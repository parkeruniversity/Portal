<%@ Control CodeBehind="ManageForms.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.PortletScreens.ManageForms" %>
