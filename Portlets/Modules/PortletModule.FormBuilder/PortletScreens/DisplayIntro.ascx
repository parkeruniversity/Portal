<%@ Control CodeBehind="DisplayIntro.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.PortletScreens.DisplayIntro" %>
	...
	<div id="Layer2">
		...
		<div id="Layer4" style="visibility:hidden">
			<table cellspacing="0" cellpadding="5" border="0">
				...
				<tr>
					<td><asp:HyperLink ID="hlInstructions" Runat="server" Visible="False">Instructions</asp:HyperLink></td>
				</tr>
