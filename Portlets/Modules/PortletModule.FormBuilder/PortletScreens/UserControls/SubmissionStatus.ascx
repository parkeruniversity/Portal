<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubmissionStatus.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.PortletScreens.UserControls.SubmissionStatus" %>
