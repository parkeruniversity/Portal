<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReviewAndSubmit.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.PortletScreens.ReviewAndSubmit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="Layer1" class="pSection">
	...
	<table width="100%" cellpadding="5" cellspacing="0" border="0">
		...
		<tr id="trEmailTB" runat="server">
			<td class="fbBorderLeftRight">
				<%=Globalizer.Format("FB_EMAIL_SUBMSG_TXT",strAskEmailInstrux)%><br/>
                 <asp:Label runat="server" style="display: none;" Text="Rename Page Button"  ID="accesibilitynewName" AssociatedControlID="tbEmailMSG"></asp:Label>
                <asp:TextBox ID="tbEmailMSG" Runat="server" Width="250" /> <asp:Literal ID="litEmailMSGReq" Runat="server" />
			</td>
		</tr>
		<tr>
