...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PaymentOptions_View.ascx.cs" Inherits="Jenzabar.Portal.Framework.Web.PortletModules.FormBuilder.Settings.PaymentOptions_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
