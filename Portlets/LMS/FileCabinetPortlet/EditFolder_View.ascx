<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditFolder_View.ascx.cs" Inherits="Jenzabar.LMS.Portlets.FileCabinetPortlet.EditFolder_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
		...
		<fieldset>
			<table>
				...
				<tr>
					<th>&nbsp;</th>
					<td>
						<cmn:GlobalizedButton id="btnSave" UseSubmitBehavior="true" textkey="TXT_SAVE" runat="server" />
