<%@ Control Language="c#" AutoEventWireup="false" Codebehind="HandoutGrid.ascx.cs" Inherits="Jenzabar.LMS.Portlets.FileCabinetPortlet.HandoutGrid" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<div>
    <asp:GridView runat="server" id="ggMain" CssClass="assignmentGrid itemHover" AlternatingRowStyle-CssClass="altAssignmentGrid" HeaderStyle-CssClass="headerAssignmentGrid"  CellPadding="0" CellSpacing="0" AutoGenerateColumns="False" >
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <%# this.GetEmptyStringOrEvaluateField(Container.DataItem, "Properties[\"Created\"]", "{0:d}", typeof(DateTime))%>
                </ItemTemplate>
            </asp:TemplateField>
