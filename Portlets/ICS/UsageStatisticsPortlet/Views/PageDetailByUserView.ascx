<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PageDetailByUserView.ascx.cs" Inherits="Jenzabar.ICS.Web.Portlets.UsageStatisticsPortlet.Views.PageDetailByUserView" %>
            ...
            <td valign="top" style="width: 75%;">
                <table cellpadding="5">
                    <tr>
                        ...
                        <td valign="top">
                            <asp:Label ID="lblPage" runat="server" CssClass="BoldText" />
                            <asp:Label ID="lblActivity" runat="server" CssClass="BoldText" />
                            <asp:Label ID="lblByVisitor" runat="server" />
                            <br />
                    ...
                    <tr>
                        ...
                        <td class="BoldText">
                            <a id="lnkMostActiveVisitor" runat="server">
                                <asp:Label ID="lblMostActiveVisitorValue" runat="server" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grdUsers" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Activity" SortExpression="Rating">
                                    <ItemTemplate>
                ...
                <table id="NavigationTable" class="NavigationTable" cellspacing="0">
                    ...
                    <tr>
                        <td class="NavigationTableBodyCell">
                            <img src="ui/common/images/PortletImages/Icons/icon_page_byport_32.gif" alt="Page Detail" />
                        </td>
                        <td class="NavigationTableBodyCell">
                    ...
                    <tr>
                        <td class="NavigationTableBodyCell">
                            <img src="ui/common/images/PortletImages/Icons/icon_report_32.gif" alt="Page Detail Report" />
                        </td>
                        <td class="NavigationTableBodyCell">
                            <a id="lnkPageDetailReport" runat="server">
                                <asp:Label ID="lblPageDetailReport" runat="server" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td class="NavigationTableBodyCell">
                            <img src="ui/common/images/PortletImages/Icons/icon_pages_16.gif" alt="Activity by Page" />
                        </td>
                        <td class="NavigationTableBodyCell">
