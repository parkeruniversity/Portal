<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserSessionDetailView.ascx.cs"
    Inherits="Jenzabar.ICS.Web.Portlets.UsageStatisticsPortlet.Views.UserSessionDetailView" %>
        ...
        <tr>
            <td valign="top" style="width: 75%;">
                <table cellpadding="5">
                    <tr>
                        <td valign="top">
                            <img src="ui/common/images/PortletImages/Icons/icon_usersession_32.gif" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="lblDate" runat="server" CssClass="BoldText" />
                            <asp:Label ID="lblActivityReport" runat="server" CssClass="BoldText" />
                            <br />
                            <asp:Label ID="lblStartTime" runat="server" />
                            <asp:Label ID="lblTimeSeperator" runat="server" />
                            <asp:Label ID="lblEndTime" runat="server" />
                            <br />
                            <asp:Label ID="lblTimeSpan" runat="server" />
                        </td>
                    </tr>
                </table>
                <common:Mirror ID="Mirror1" ControlID="paging" runat="server" />
                <div id="divGridView" runat="server">
                    <asp:GridView ID="grdActions" runat="server" AutoGenerateColumns="False" CellPadding="4"
