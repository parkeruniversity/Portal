<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ThreadSingleMsg_View.ascx.cs" Inherits="Jenzabar.ICS.Web.Portlets.BulletinBoardPortlet.ThreadSingleMsg_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<jenzabar:groupedgrid id=MessageGrid runat="server" AllowSorting="true" CellPadding="0" DataKeyField="ID" GroupKeyField="ID" RenderGroupHeaders="true">
			...
			<Columns>
				<asp:TemplateColumn HeaderText="#" SortExpression="ReplyNumber">
					<ItemTemplate>
						<%# DataBinder.Eval( Container.DataItem, "ReplyNumber" )%>
					</ItemTemplate>
				</asp:TemplateColumn>
