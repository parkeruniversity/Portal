<%@ Control Language="C#" Debug="true" AutoEventWireup="true" CodeBehind="Main_View.ascx.cs"
    Inherits="Jenzabar.ICS.Web.Portlets.LearningToolsPortlet.Main_View" %>
...
<div class="pSection">
    ...
    <br />
    <asp:LinkButton ID="lnkButtonSelectTool" Text="Select BasicLTI Tool" CommandName="SelectTool"
        Visible="true" runat="server" />
    <br />
    <p>
