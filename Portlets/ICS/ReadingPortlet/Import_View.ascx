<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Import_View.ascx.cs" Inherits="Jenzabar.ICS.Web.Portlets.ReadingPortlet.Import_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>

<%@ Register TagPrefix="Common" namespace="Jenzabar.Common.Web.UI.Controls" assembly="Jenzabar.Common" %>
<%@ Register TagPrefix="ReadingPortlet" tagname="ReadingGrid" src="~/Portlets/ICS/ReadingPortlet/FileCabinet/ReadingGrid.ascx" %>
...
<div class="pSection">
    <ReadingPortlet:ReadingGrid ID="reading_grid" runat="server" />
</div>
